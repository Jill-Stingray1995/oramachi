...
const QUESTIONS = {
  ...
  melon_hokota: {text:'メロンの産地として全国的に知られる?', icon:'🍈'},
  ...
  kiryu_nokogiri: {text:'織物工場のノコギリ屋根が多く残り、「球都」と呼ばれる?', icon:'🏭'},
  tsutsujigaoka_bunbuku: {text:'つつじが岡公園と分福茶釜の伝説で知られる?', icon:'🌺'},
  ...
  konosu_hina: {text:'日本一高いピラミッドひな壇で知られる?', icon:'🎎'},
  first_outlet: {text:'日本初のアウトレットモールが開業した地?', icon:'🛍️'},
  jumbo_koinobori: {text:'全長100メートルのジャンボこいのぼりを揚げる?', icon:'🎏'},
  higashimatsuyama_yakitori: {text:'豚のカシラ肉をみそだれで食べる「やきとり」で有名?', icon:'🍢'},
  ...
  sakitama_zerifry: {text:'さきたま古墳群とゼリーフライで有名?', icon:'🏺'},
  ...
  abiko_ekisoba: {text:'大きな唐揚げが乗った駅そばで有名?', icon:'🍜'},
  ...
  katsuura_tantanmen: {text:'夏でも比較的冷涼で、ご当地タンタンメンで知られる?', icon:'🍜'},
  ...
  shirokoro_horumon: {text:'豚ホルモンを使う「シロコロホルモン」で有名?', icon:'🍢'},
  ...
  jogashima_maguro: {text:'城ヶ島と三崎まぐろで知られる?', icon:'🐟'},
  daiyuzan_kintaro: {text:'大雄山と金太郎伝説で知られる?', icon:'🏔️'},
  okutadami_dam: {text:'奥只見ダムがある?', icon:'🏞️'},
  hokuetsu_kyoto: {text:'「北越の小京都」と呼ばれる?', icon:'🏘️'},
  ...
  sakyu_momo: {text:'「幻の桃」と呼ばれる砂丘桃の産地?', icon:'🍑'},
  ...
  sakurai_futamigaura: {text:'海中の夫婦岩と白い鳥居で知られる桜井二見ヶ浦がある?', icon:'⛩️'},
  ...
  hikari_no_michi: {text:'宮地嶽神社の参道に夕日が重なる「光の道」で知られる?', icon:'🌇'},
  tanabata_jinja: {text:'織姫を祭る「七夕神社（媛社神社）」がある?', icon:'🎋'},
  nogata_meteorite: {text:'須賀神社に、世界最古級の落下記録を持つ隕石が伝わる?', icon:'☄️'},
  yanagawa_kudari: {text:'掘割の川下りと北原白秋の生家で知られる?', icon:'🛶'},
  yame_gyokuro: {text:'福島地区に白壁の町並みが残り、玉露の産地として知られる?', icon:'🍵'},
  ...
  chikugo_yoshii: {text:'筑後吉井の白壁の町並みと果樹園で知られる?', icon:'🏘️'},
  ...
  takasakiyama_saru: {text:'高崎山のサルが有名?', icon:'🐒'},
  fukuzawa_karaage: {text:'福澤諭吉が生まれ、からあげの聖地として知られる?', icon:'🍗'},
  ...
  tsukumi_sakura_maguro: {text:'四浦半島の河津桜と保戸島のマグロ漁業で知られる?', icon:'🌸'},
  sekinoo_taki: {text:'関之尾滝と世界最大級の甌穴群がある?', icon:'💦'},
  nobeoka_ishigaki: {text:'城跡に「千人殺し」と呼ばれる高石垣が残る?', icon:'🏯'},
  ...
  shirokuma_tenmonkan: {text:'天文館の「しろくま」で有名?', icon:'🍧'},
  ...
  kinsakubaru_keihan: {text:'金作原原生林があり、郷土料理の鶏飯で知られる?', icon:'🌴'},
  satsumayaki_miyama: {text:'薩摩焼の里・美山と妙円寺詣りで知られる?', icon:'🏺'},
  ...
  makurazaki_station: {text:'JR日本最南端の始発・終着駅があり、かつお節で知られる?', icon:'🚉'},
  ...
  koza_eisa: {text:'全島エイサーまつりと「コザ」の音楽文化で知られる?', icon:'🥁'},
  ...
  tebukuro_industry: {text:'手袋の生産量が日本一として知られる?', icon:'🧤'},
  uchinuki: {text:'名水「うちぬき」が市内各地から湧き出る?', icon:'💧'},
  garyu_sanso: {text:'臥龍山荘や肱川の鵜飼で知られる?', icon:'🏯'},
  kezuribushi: {text:'削り節の生産が盛んな港町?', icon:'🐟'},
  yawatahama_champon: {text:'ご当地麺「○○○（市名）ちゃんぽん」で知られる?', icon:'🍜'},
  ...
  chinkabashi: {text:'四万十川に架かる多くの沈下橋で知られる?', icon:'🌉'},
  ...
  daruma_yuhi: {text:'冬の海に沈む「だるま夕日」で知られる?', icon:'🌇'},
  ashizuri_misaki: {text:'四国最南端の足摺岬がある?', icon:'🗺️'},
  tosabushi: {text:'一本釣りの鰹節「土佐節」で知られる?', icon:'🐟'},
  ...
  magose_hinoki: {text:'熊野古道の馬越峠と、ヒノキの産地で知られる?', icon:'🌲'},
  ...
  metasequoia_shirahige: {text:'メタセコイア並木と湖中の大鳥居がある神社で知られる?', icon:'🌳'},
  gokasho_eigenji: {text:'五個荘の近江商人屋敷と永源寺がある?', icon:'🏘️'},
  maizuru_akarenga: {text:'海上自衛隊の基地と赤れんが倉庫群がある?', icon:'⚓'},
  byodoin_uji: {text:'平等院鳳凰堂と高級茶の産地で知られる?', icon:'⛩️'},
  ...
  kashiwara_budo: {text:'ブドウ栽培と亀の瀬地すべり地帯で知られる?', icon:'🍇'},
  ojin_ryo_wine: {text:'世界遺産の古墳群にある巨大な応神天皇陵とワインで知られる?', icon:'🍷'},
  ...
  ashiya_yodoko: {text:'高級住宅地として知られ、ヨドコウ迎賓館がある?', icon:'🏡'},
  ...
  sanda_hitohaku: {text:'県立の「人と自然の博物館」とブランド牛で知られる?', icon:'🐄'},
  ...
  kuroe_shikki: {text:'黒江の町並みと紀州漆器で知られる?', icon:'🥢'},
  ...
  kokawadera_momo: {text:'西国三十三所第3番札所と桃の産地で知られる?', icon:'🍑'},
  ...
  merhen_kenchiku: {text:'西洋風の「メルヘン建築」が多い?', icon:'🏰'},
  ...
  senmaida_shikki: {text:'白米千枚田と漆器産業で知られる?', icon:'🌾'},
  ...
  miketsukuni_saba: {text:'御食国と鯖街道の起点として知られる?', icon:'🐟'},
  echizen_ono_castle: {text:'雲海に浮かぶ山城と湧水で知られる?', icon:'🏯'},
  ...
  ningyogeki_tenryukyo: {text:'人形劇フェスタと天龍峡で知られる?', icon:'🎭'},
  suzaka_garyu: {text:'蔵の町並みと臥竜公園がある?', icon:'🏞️'},
  kaikoen_toson: {text:'懐古園と島崎藤村ゆかりの町?', icon:'🏯'},
  takato_sakura: {text:'高遠城址公園の桜で知られる?', icon:'🌸'},
  sauce_katsudon: {text:'ソースカツ丼で有名?', icon:'🍚'},
  ...
  naraijuku_wine: {text:'奈良井宿と国産ワインで知られる?', icon:'🍷'},
  ...
  nagaragawa_ukai: {text:'長良川の鵜飼で有名?', icon:'🐦'},
  okuno_hosomichi_musubi: {text:'奥の細道むすびの地で「水の都」と呼ばれる?', icon:'💧'},
  hida_furuimachi: {text:'飛騨の古い町並みと日本三大美祭がある?', icon:'🏘️'},
  mosaic_tile_museum: {text:'モザイクタイルミュージアムと永保寺がある?', icon:'🏛️'},
  magome_kurikinton: {text:'馬籠宿と栗きんとんで知られる?', icon:'🌰'},
  udatsu_mino: {text:'うだつの上がる町並みと手すき和紙で知られる?', icon:'🏘️'},
  kaseki_museum: {text:'化石博物館と陶磁器産業で知られる?', icon:'🦴'},
  iwamura_akechi: {text:'岩村城下町と明知鉄道がある?', icon:'🏯'},
  otajuku_satoyama: {text:'中山道太田宿と里山体験型公園がある?', icon:'🏘️'},
  toki_outlet: {text:'陶磁器生産と大型アウトレットで知られる?', icon:'🏺'},
  ...
  horaibashi_sl: {text:'世界最長級の木造歩道橋とSL列車で知られる?', icon:'🌉'},
  gakunan_tagonoura: {text:'岳南電車と田子の浦港がある?', icon:'🚃'},
  yaizu_katsuo: {text:'遠洋漁業の港とカツオ・マグロで知られる?', icon:'🐟'},
  ...
  senkagawa_fukamushi: {text:'千框棚田と深蒸し茶で知られる?', icon:'🍵'},
  ...
  nihon_denmark: {text:'「日本デンマーク」と呼ばれ七夕祭りが有名?', icon:'🌾'},
  ...
  mandaraji_fuji: {text:'曼陀羅寺の藤まつりで知られる?', icon:'🌸'},
  komaki_castle: {text:'織田信長が初めて築いた城山がある?', icon:'🏯'},
  konomiya_hadaka: {text:'国府宮のはだか祭と植木・苗木で知られる?', icon:'⛩️'},
  ...
  kakitsubata_chiryu: {text:'無量寿寺のかきつばたと東海道の宿場で知られる?', icon:'🌸'},
  ...
  sendohira_renkon: {text:'船頭平閘門とレンコン産地で知られる?', icon:'🌿'},
  kiyosu_castle: {text:'清洲城と大規模なビール工場がある?', icon:'🏯'},
  showa_nichijo: {text:'昭和日常博物館がある?', icon:'🏛️'},
  kingyo_yatomi: {text:'金魚養殖と金魚水族館で知られる?', icon:'🐠'},
  miyoshi_canoe: {text:'三好池でカヌー競技が盛ん?', icon:'🛶'},
  ...
  koedo:               {text:'舟運と蔵造りの町並みで知られる小江戸三市の一つ?', icon:'🏮'},
  ...
  lucky_star: {text:'アニメ『らき☆すた』の聖地として知られる鷲宮神社がある？', icon:'⛩️'},
  ...
  nonbori_arai: {text:'五条川の桜並木と「のんぼり洗い」で知られる?', icon:'🎏'},
  ...
  konrei_kagu: {text:'高級婚礼家具の産地として知られる？', icon:'🪑'},
