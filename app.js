const KEYS = [
'pop1m','shinkansen','coastal','designated','festival','castle','snow_festival','worldheritage','snow','basin','airport','capital','noodle','mascot_famous',
  ...
  'sanin_area','sanyo_area','izumo_area','bingo_area','hiroshima_metro','chugoku_mountain_basin','setouchi_industrial','sanin_main_line','sanyo_main_line','hakubi_line','yosan_line','dosan_line','sanuki_area','awa_area','iyo_area','toyo_area','chuyo_area','nanyo_area','honshu_bridge','paper_industry_shikoku',
  'northern_kyushu','southern_kyushu','ariake_coast','fukuoka_metro','kitakyushu_area','chikugo_area','chikuho_area','chikuzen_area','satsuma_area','osumi_area','okinawa_main_island','okinawa_south_central','sakishima_islands','kagoshima_main_line','nippo_main_line','nishitetsu_line',
  'color_in_name','animal_in_name','plant_in_name','body_part_in_name','kawa_in_name','yama_in_name','shima_in_name','sea_word_in_name','ta_in_name','big_small_in_name','new_old_in_name','pref_name_in_city_name','same_name_other_pref','four_plus_name','hard_to_read_name',
];
...
const MODES = {
  all: {
    label: '全国版',
    description: '日本の全部の市、および新潟県の町村と東京23区'
  },
  niigata: {
    label: '新潟県版',
    description: '新潟県の全市町村で当てます'
  },
  tokyo: {
    label: '東京都版',
    description: '東京23区と多摩地域の全部の市'
  },
  ...
  stage.innerHTML = `
    ...
    <div class="mode-select">
      <button class="mode-btn" onclick="startMode('all')">
        ...
        <span class="mode-desc">日本の全部の市、および新潟県の町村と東京23区で当てます</span>
      </button>

      <button class="mode-btn mode-niigata" onclick="startMode('niigata')">
        <span class="mode-title">新潟県版</span>
        <span class="mode-desc">新潟県の全市町村で当てます</span>
      ...
      <button class="mode-btn mode-tokyo" onclick="startMode('tokyo')">
        ...
        <span class="mode-desc">東京23区と多摩地域の全部の市で当てます</span>
