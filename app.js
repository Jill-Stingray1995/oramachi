...
const QUESTIONS = {
  ...
  yuki_tsumugi: {text:'ユネスコ無形文化遺産に登録された高級絹織物の産地？', icon:'🧵'},
  shimotsuma_movie: {text:'ロリータファッションの少女とヤンキー少女が登場する映画の舞台？', icon:'🎬'},
  shimodate_sl: {text:'SL列車の発着駅となる「下館駅」がある？', icon:'🚂'},
  ...
  linear_center: {text:'山梨県立リニア見学センターがある？', icon:'🚄'},
  yamanashi_medical: {text:'山梨大学医学部附属病院がある？', icon:'🏥'},
  kanto_kannon: {text:'関東三観音の一つとされる巨大な平和観音がある？', icon:'🗿'},
...
const MASCOT_ASSET_VERSION = '20260714f';
const MASCOT_IMAGES = {
